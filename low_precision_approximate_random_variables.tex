...
\end{enumerate}
\item Calculate expected time savings. 
\item Mention that with the Milstein scheme all the work is on the coarsest levels, so half precision is golden, and possible needn't require compensation (albeit Milstein does use a bit more arithmetic).
\end{enumerate}
\end{enumerate}
}
